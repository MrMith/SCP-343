...
namespace SCP_343
{
	...
	public class PluginOptions
	{
		...
		public int SCP343_HeckTime { get; set; }
		...
		public void UpdateValues(Plugin plugin)
		{
			...
			SCP343_HeckTime = plugin.GetConfigInt("scp343_hecktime");
