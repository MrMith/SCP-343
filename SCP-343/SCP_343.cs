...
namespace SCP_343
{
	...
	class SCP343 : Plugin
	{
		...
		public override void Register()
		{
			...
			this.AddConfig(new Smod2.Config.ConfigSetting("scp343_heck", true, true, "Should players be allowed to use the .heck343 client command to respawn themselves as d-class within scp343_hecktime seconds of round start."));
			this.AddConfig(new Smod2.Config.ConfigSetting("scp343_hecktime", 30, true, "How long people should beable to respawn themselves as d-class."));
